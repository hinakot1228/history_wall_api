...
@section('content')
    ...
    <form class="row g-3" action="{{ route('questions.store') }}" method="POST">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="name" value="{{ old('name') }}" placeholder="行川太盛">
        </div>
        <div class="input-group">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="image_path" value="{{ old('image_path') }}" placeholder="未定やねん....(◞‸◟)">
        </div>
        <div class="input-group">
            <span class="input-group-text">肩書き</span>
            <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="position" value="{{ old('position') }}" placeholder="第１代　盛り上げ隊長">
        </div>
        <div class="input-group">
            <span class="input-group-text">説明文</span>
            <textarea class="form-control" aria-label="With textarea" name="explanation" placeholder="seed-kの盛り上げ隊長兼ログインエンジニアです。">{{ old('explanation') }}</textarea>
        </div>
        <div class="col-12 create_button_container">
            <button type="submit" class="btn btn-outline-success" id="play">追加</button>
        </div>
    </form>
@endsection